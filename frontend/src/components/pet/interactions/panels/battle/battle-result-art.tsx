...
const PendingArt: React.FC = () => (
    <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg">
        <line x1="22" y1="14" x2="98" y2="66" stroke="#7dd6ff" strokeWidth="3" strokeLinecap="round"/>
        <line x1="98" y1="14" x2="22" y2="66" stroke="#7dd6ff" strokeWidth="3" strokeLinecap="round"/>
...
const VictoryArt: React.FC = () => (
    <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M22 62 L22 36 L36 50 L60 18 L84 50 L98 36 L98 62 Z" fill="rgb(0 255 157 / 16%)" stroke="#0fffae" strokeWidth="2.5" strokeLinejoin="round"/>
        <rect x="16" y="62" width="88" height="10" rx="3" fill="rgb(0 255 157 / 18%)" stroke="#0fffae" strokeWidth="2"/>
...
const DefeatArt: React.FC = () => (
    <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M60 8 L92 24 L92 50 Q92 70 60 76 Q28 70 28 50 L28 24 Z" fill="rgb(255 110 196 / 10%)" stroke="#ff9ad6" strokeWidth="2.5" strokeLinejoin="round"/>
        <path d="M54 18 L62 36 L57 44 L66 62" stroke="#ff9ad6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
        <circle cx="46" cy="38" r="5" fill="rgb(255 110 196 / 22%)" stroke="#ff9ad6" strokeWidth="1.5"/>
        <circle cx="74" cy="38" r="5" fill="rgb(255 110 196 / 22%)" stroke="#ff9ad6" strokeWidth="1.5"/>
