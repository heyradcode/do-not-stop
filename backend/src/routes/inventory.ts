...
router.post('/use', verifyToken, inventoryWriteRateLimit, postUseItem);
router.post('/entitlements/:id/claim', verifyToken, inventoryWriteRateLimit, postClaim);
...
router.post('/admin/grant', verifyToken, inventoryWriteRateLimit, postGrant);
