...
const IncomingProposalRow: React.FC<IncomingProposalRowProps> = ({ proposal, targetPetName, busy, onAccept }) => (
    <li className="proposal-card">
        <div className="proposal-pets">
            <span className="proposal-proposer">{proposal.proposerPetName} <span className="proposal-id">#{proposal.proposerPetId}</span></span>
            <span className="proposal-arrow">→</span>
            <span className="proposal-target">your {targetPetName(proposal.targetPetId)} <span className="proposal-id">#{proposal.targetPetId}</span></span>
        </div>
